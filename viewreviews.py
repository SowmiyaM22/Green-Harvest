...
if(form.getvalue('submit')!="None" and form.getvalue('type')=="all"):
    sql="select * from product where email='%s'"%(email)
elif(form.getvalue('submit')!="None" and form.getvalue('type')=="fruit"):
    sql="select * from product where email='%s' and pcategory='Fruit'"%(email)
elif(form.getvalue('submit')!="None" and form.getvalue('type')=="vegetable"):
    sql="select * from product where email='%s' and pcategory='Vegetable'"%(email)
elif(form.getvalue('submit')!="None" and form.getvalue('type')=="grain"):
    sql="select * from product where email='%s' and pcategory='Grains'"%(email)
else:
    sql="select * from product where email='%s'"%(email)
