...
try:
    ...
    if(dbcon):
        ...
        for row in result:
            ...
            print("<td align='center'><img src=Fileupload/Trees/%s width=100 height=100></td>"%(imagename))
            print("<td align='center'>%s</td>"%(grows))
            print("<td align='center'>%s</td>"%(season))
            print("<td align='center'>%s</td>"%(compost))
            print("<td align='center'><a href=deletetrees.py?q=%s&r=%s>Delete</a></td>"%(sno,imagename))
            print("</tr>")
        print("""</table>
