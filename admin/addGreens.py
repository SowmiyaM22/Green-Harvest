...
<body>
<form action="insertgreens.py" name="login" method="post" enctype="multipart/form-data">
...
<a href="viewgreens.py"><input type="button" value="VIEW" style="width:150px;height:30px;background-color:teal;"></a>
