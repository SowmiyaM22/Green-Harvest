...
<body>
<form action="insertcrops.py" name="login" method="post" enctype="multipart/form-data">
...
<a href="viewcrops.py"><input type="button" value="VIEW" style="width:150px;height:30px;background-color:teal;"></a>
</td>
</tr>		 
</table>
